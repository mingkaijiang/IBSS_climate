...
ConvertFiles_tmax(sourceDir = "data/ghcnd_all/ghcnd_all/",
                  ...
                  destDir = "data/ghcnd_tmax_selected_tmax")

### Step 2:
### Restructure the files to continuous days, added leap years
### Replacing old with new files
ReStructureFile(sourceDir = "data/ghcnd_tmax_selected_tmax", destDir = "data/restructured_tmax")
...
Gap_Fill_5_stations(stationDF2, 
                    sourceDir = "data/ghcnd_tmax_gap_filled_tmax", 
                    destDir = "data/ghcnd_tmax_gap_filled_tmax")
...
YrRange10(sourceDir = "data/ghcnd_tmax_gap_filled_tmax")


### Step 7:
### Update stationDF2 to remove all removed stations from this list 
### and add the growing season information
final_station_DF <-Final_station_list_5_stations(sourceDir = "data/ghcnd_tmax_gap_filled_tmax", 
                                                 stationDF.upd,
                                                 outname="tmax")
