...
ConvertFiles_tmax(sourceDir = "data/ghcnd_all/ghcnd_all/",
             stations = station.list,
             destDir = "data/ghcnd_tmax_selected")

### Step 2:
### Restructure the files to continuous days, added leap years
### Replacing old with new files
ReStructureFile(sourceDir = "data/ghcnd_tmax_selected", destDir = "data/restructured_tmax")
...
station.list.upd <- Missing_check(station.list, 
                                  ...
                                  destDir = "data/ghcnd_tmax_gap_filled")
...
Gap_Fill(stationDF2, 
         sourceDir = "data/ghcnd_tmax_gap_filled", 
         destDir = "data/ghcnd_tmax_gap_filled")
...
YrRange10(sourceDir = "data/ghcnd_tmax_gap_filled")


### Step 7:
### Update stationDF2 to remove all removed stations from this list 
### and add the growing season information
final_station_DF <-Final_station_list_4(sourceDir = "data/ghcnd_tmax_gap_filled", stationDF.upd)
...
ThrIndS_tmax(sourceDir = "data/ghcnd_tmax_gap_filled", destDir = "data/indices/ThrIndS_tmax")
