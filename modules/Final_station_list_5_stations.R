...
Final_station_list_5_stations<-function(sourceDir = DAILY.DATA.DIRECTORY, sDF,
                             outname)
{
    ...
    outDF <- Update_station_list_5_stations(st.df, sDF)
